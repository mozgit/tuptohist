...
def PlotITLabels(hist):
  ...
  it1 = R.TText()
  it1.DrawText(-0.3, -8.5, "IT1")
  it2 = R.TText()
  it2.DrawText(-0.3, -0.5, "IT2")
  it3 = R.TText()
  it3.DrawText(-0.3, 7.5, "IT3")
  itA = R.TText()
  itA.SetTextSize(0.07)
  itA.DrawText(-11.5, -0.5, "A")
  itC = R.TText()
  itC.SetTextSize(0.07)
  itC.DrawText(11.1, -0.5, "C")
  XArrow = R.TArrow()
  XArrow.DrawArrow(0.,-12.,-5.5,-12.,0.005,"|-|>")
  X = R.TText()
  X.SetTextSize(0.04)
  X.DrawText(-5.9, -12.5, "X")
